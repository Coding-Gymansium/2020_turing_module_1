Iteration 3
You have been contracted by the University of Denver to write a program that 
can track terms. 
Specifically, they would like you to implement the following functionality:

[x] Each term has a name, like "Winter 2018" as well as 

[x] a way to read that data

[x] Each term has a list of multiple courses

[x] A term can list all courses that are open. 

[x] A course is open if it has fewer students than its capacity.

[x] A term can list all student names across all courses.
